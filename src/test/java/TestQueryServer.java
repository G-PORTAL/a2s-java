...
public class TestQueryServer {
	...
	public static void initClientAndServer() throws UnknownHostException {
		...
		server = new QueryServer(new InetSocketAddress(InetAddress.getLocalHost(), 27017), new ServerInfo(null, (byte)17, "ExampleServer", "ExampleMap", "ExampleFolder", "ExampleGame", (short)0, (byte)4, (byte)10, (byte)0, 'd', 'l', false, true, "1.0.0.0", null, null, null, null, null, null));
